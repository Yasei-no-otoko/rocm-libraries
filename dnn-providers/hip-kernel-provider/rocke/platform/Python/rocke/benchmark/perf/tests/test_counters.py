...
_CDNA9 = [
    "GRBM_COUNT", "GRBM_GUI_ACTIVE", "SQ_BUSY_CYCLES", "SQ_WAVES", "SQ_WAIT_ANY",
    "SQ_INSTS_VALU", "SQ_INSTS_LDS", "TCC_HIT", "TCC_MISS",
]
_RDNA9 = [
    "GRBM_COUNT", "GRBM_GUI_ACTIVE", "SQ_BUSY_CYCLES", "SQ_WAVES", "SQ_WAIT_ANY",
    "SQ_INSTS_WAVE32_VALU", "SQ_INSTS_WAVE32_LDS", "GL2C_HIT", "GL2C_MISS",
]
