...
function(hipblaslt_create_device_library)
    ...
    # StreamK work-stealing codegen toggle: when set (off|only), pass it through to
    # TensileCreateLibrary via the TENSILE_STREAMK_WS_MODE env var so device libs can
    # be built with or without work-stealing kernels.
    set(_tcl_env "")
    if(_cdl_STREAMK_WS_MODE)
        set(_tcl_env ${CMAKE_COMMAND} -E env "TENSILE_STREAMK_WS_MODE=${_cdl_STREAMK_WS_MODE}")
    endif()
    set(_tcl_command
        ${_tcl_env}
